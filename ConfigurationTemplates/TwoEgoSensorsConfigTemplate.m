...
EgoConfig.Ego(1).ActionType = 'Continuous';                                 %(optional) Options: 'Discrete-MetaAction', 'Discrete', 'Continuous' Default: 'Discrete-MetaAction'
...
%     EgoConfig.Ego(1).OccupancyGrid.plot = false;                            % (optional) Default = false 
