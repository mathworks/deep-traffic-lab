...
EgoConfig.Ego(1).ModelType = 'Bicycle';                                    %(optional) Options: 'Bicycle', 'SUMO' Default: SUMO
EgoConfig.Ego(1).ActionType = 'Discrete';                                %(optional) Options: 'Discrete-MetaAction', 'Discrete', 'Continuous' Default: 'Discrete-MetaAction'
...
EgoConfig.Ego(1).SpawnOptions.departPos = 'base';                   %(Optional) Options: {≥0, 'random', 'free', 'random_free', 'base', 'last', 'stop'} Default = 'random' 
