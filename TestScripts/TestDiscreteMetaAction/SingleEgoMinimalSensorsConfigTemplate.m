...
EgoConfig.Ego(1).SpawnOptions.departLane = '2';                       %(Optional) Options: {≥0, 'random', 'free', 'allowed', 'best', 'first'} Default = 'random' 
...
EgoConfig.Ego(1).SpawnOptions.departSpeed = 'max';                      %(Optional) Options: {≥0, 'random', 'free', 'max', 'desired', 'speedLimit'} Default = 'random' 
